PRG             =main.c
OBJS            =main.o uart.o nrf24l01.o spi.o
SRCS            =main.c uart.c nrf24l01.c spi.c
...
program: $(PRG).hex
	...
	avrdude -v -p $(PROGRAMMER_TARGET) -carduino -P/dev/cu.usbmodem1411 -b115200 -D -U flash:w:$(PRG).hex 
