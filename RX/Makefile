PRG             =main.c
OBJS            =main.o uart_functions_m48.o nrf24l01.o spi.o
SRCS            =main.c uart_functions_m48.c nrf24l01.c spi.c
...
program: $(PRG).hex
	...
	avrdude -v -p $(PROGRAMMER_TARGET) -carduino -P/dev/cu.wchusbserial1420 -b57600 -D -U flash:w:$(PRG).hex 

#	avrdude -p $(PROGRAMMER_TARGET) -c avrisp2 -e -U flash:w:$(PRG).hex 
